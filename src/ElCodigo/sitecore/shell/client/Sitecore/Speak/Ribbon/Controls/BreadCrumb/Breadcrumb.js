...
function (Sitecore) {
  Sitecore.Factories.createBaseComponent({
    ...
    renderNavigationBar: function (itemId) {
      ...
      var htmlSource = "";
      htmlSource += this.generateFavTreeViewButton(this.treeViewTooltip);
    ...
    generateFavTreeViewButton: function () {
      var functionDefinition = "javascript:document.breadcrumbContext.renderFavViewIframe();";
      return "<div class='sc-breadcrumb-item' title='" + this.treeViewTooltip + "'><a id='FavTreeViewButton' class='sc-breadcrumb-item-button' href='" + functionDefinition + "'><img alt='' src='/sitecore/shell/~/icon/applications/16x16/star_yellow.png.aspx' /></a></div>";
    },
    ...
    renderFavViewIframe: function () {
      var element = window.document.getElementById("FavTreeViewButton");
      if (!element) {
        return;
      }

      var treeViewUrl = "/sitecore/client/Applications/ExperienceEditor/Pages/FavoritesNavTreeView.aspx";
      var dimensions = {
        width: "300px",
        height: "320px"
      };
